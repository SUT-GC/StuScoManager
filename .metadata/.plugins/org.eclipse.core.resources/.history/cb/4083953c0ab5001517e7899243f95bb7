                        ...
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="addcourse_context">
                                <form class="form_addcourse">
                                    ...
                                    <div class="ablock">
                                        <span>课程编号</span>
                                       <input type="text" class="form-control courseid courseid" name="courseid" placeholder="请输入新课程的编号">
                                    </div>
                                     <div class="ablock">
                                        <span>课程名称</span>
                                       <input type="text" class="form-control coursename"  coursename name="coursename" placeholder="请输入新课程的名称">
                                   </div>
                                   <div class="ablock">
                                        <span>课程属性</span>
