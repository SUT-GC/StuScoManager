                              ...
                              <div class="panel panel-default">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                  <div class="panel-body">
                                     ...
                                     <hr/>
                                     <li class="active">
                                        <a href="#"><i class="glyphicon glyphicon-chevron-right"></i> 编辑教师信息</a>
                                     </li>
                                     <hr/>
                                    <li >
                ...
                <div class="col-md-10">
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                               ...
                               <div class="row search_admin twoblock">
                                ...
                                <table class="table table-hover mytable">
                                  <thead>
                                    <th>#</th><th>教师工号</th><th>姓名</th><th>性别</th><th>年龄</th><th>学院</th><th>编辑</th><th>删除</th>
                                  </thead>
                                  <tbody>
                                    <tr>
                                       <td>1</td><td class="teacher_num">130405211</td><td class="teacher_name">Gc</td><td class="teacher_sex">男</td><td class="teacher_age">20</td><td class="teacher_collage">信息科学与工程学院</td><td class="teacher_edit"><button class="btn btn-primary" type="submit">edit</button></td><td class="teacher_edit_delete"><button class="btn btn-danger" type="submit">delete</button></td>
                                    </tr>
                                     <tr>
                                       <td>1</td><td class="teacher_num">130405211</td><td class="teacher_name">Gc</td><td class="teacher_sex">男</td><td class="teacher_age">20</td><td class="teacher_collage">信息科学与工程学院</td><td class="teacher_edit"><button class="btn btn-primary" type="submit">edit</button></td><td class="teacher_edit_delete"><button class="btn btn-danger" type="submit">delete</button></td>
                                    </tr>
                                     <tr>
                                       <td>1</td><td class="teacher_num">130405211</td><td class="teacher_name">Gc</td><td class="teacher_sex">女</td><td class="teacher_age">28</td><td class="teacher_collage">信息科学与工程学院</td><td class="teacher_edit"><button class="btn btn-primary" type="submit">edit</button></td><td class="teacher_edit_delete"><button class="btn btn-danger" type="submit">delete</button></td>
                                    </tr>
                                     <tr>
                                       <td>1</td><td class="teacher_num">130405211</td><td class="teacher_name">Gc</td><td class="teacher_sex">男</td><td class="teacher_age">20</td><td class="teacher_collage">信息科学与工程学院</td><td class="teacher_edit"><button class="btn btn-primary" type="submit">edit</button></td><td class="teacher_edit_delete"><button class="btn btn-danger" type="submit">delete</button></td>
                                    </tr>
                    ...
                    <div class="show_oneteacher">
                        <div class="row">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                     <div class="text-muted bootstrap-admin-box-title"><button class="return_show_allteacher"><a>返回</a> </button>/ <a >编辑信息页面  </a></div>
                                </div>
                                <div class="addteacher_context">
                                    ...
                                    <div class="twoblock">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control newteachernum" placeholder="请输入新教师的工号">
                                            </div>
                                        </div>
                                    </div>  <hr/>
                                    <div class="ablock">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control newteachername" placeholder="请输入新教师的姓名">
                                            </div>
                                        </div>
                                    </div>  <hr/>
                                    <div class="twoblock">
                                        <div class="row">
                                          <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                           <input type="text" class="form-control newteacherage" placeholder="请输入新教师的年龄">
                                          </div>
                                          <div class="col-md-1">
                                          </div>
                                          <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control">
                                                  <option class="newteachercollage">信息科学与工程学院</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>  <hr/>
                                    <div class="ablock">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="password" class="form-control" value="000000">
                                            </div>
                                        </div>
                                    </div>  <hr/>
