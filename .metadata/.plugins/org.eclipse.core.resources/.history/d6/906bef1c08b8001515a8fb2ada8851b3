		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					...
					<li class="active"><a href="page_teacherenterscore"><i
							class="glyphicon glyphicon-chevron-right"></i> 录入成绩</a></li>
					<li><a href="page_teacherselectscore"><i
			...
			<div class="col-md-10">
				...
				<div class="panel panel-default bootstrap-admin-no-table-panel">
					<div class="panel-heading">
						<div class="text-muted bootstrap-admin-box-title">录入成绩</div>
					</div>
					<div class="row enterscore_context">
						<div class="twoblock">
							<div class="row">
								<div class="col-md-1">
									<label>课程：</label>
								...
								<div class="col-md-11">
									<select class="form-control courseid" name="courseid" >
											<s:iterator value="list" status="st">
												<option value="<s:property value='list[#st.index][0]'/>"><s:property value="list[#st.index][1]" /></option>
											</s:iterator>
										</select>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-1">
									<input class="btn btn-success button_selectallstudent" type="button" value="查询" />
								</div>
							</div>
						</div>
						<hr />
