                  ...
                  <div class="show_alladmin">
                   ...
                   <div class="edit_oneadmin">
                    <div class="row">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title"><button  class="return_show_alladmin"><a href="page_editadmin">返回</a> </button>/ <a >编辑信息页面  </a></div>
                            </div>
                            <div class="edit_admincontext">
                              <form class="form_editadmin">
                                    <h2>请编辑管理员信息</h2>
                                    <input type="text " style="display:none"class="oldadminnum" name="oldadminnum">
                                    <div class="ablock">
                                        <span>管理员姓名</span>
                                       <input type="text" class="form-control new_adminname" name="new_adminname">
                                    </div>
                                     <div class="ablock">
                                        <span>管理员账号</span>
                                       <input type="text" class="form-control new_adminnum" name="new_adminnum">
                                   </div>
                                    <div class="ablock">
                                        <span>管理员密码</span>
                                       <input type="text" class="form-control new_adminpass" name="new_adminpass" placeholder="如果什么都不输入，则不修改原来的密码">
                                   </div>
                                   <div class="button_submit_reset">
                                    <button class="btn btn-success submit_editadmin" type="button">提交</button>
                               </form>
                             </div>
