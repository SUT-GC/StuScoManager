                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    ...
                                    <hr/>
                                    <li class="active">
                                        <a href="#"><i class="glyphicon glyphicon-chevron-right"></i> 添加管理员</a>
                                    </li>
                                    <hr/>
                                    <li>
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="addadmin_context">
                            <form class="form_addadmin">
                                <h2>请输入新的管理员信息</h2>
                                <div class="ablock">
                                    <span>管理员姓名</span>
                                    <input type="text" class="form-control adminname"   name="adminname" placeholder="请输入新管理员姓名">
                                </div>
                                <div class="ablock">
                                    <span>管理员账号</span>
                                    <input type="text" class="form-control adminid" name="adminid" placeholder="请输入新管理员账号">
                                </div>
                                <div class="ablock">
                                    <span>管理员密码</span>
                                    <input type="text" class="form-control adminpassword" name = "adminpassword" placeholder="请输入新管理员密码">
                                </div>
                                <div class="button_submit_reset">
                                    <button class="btn btn-success submit_addadmin" type="button">提交</button>
