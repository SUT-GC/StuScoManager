 ...
 * Generated at: 2016-01-09 10:53:39 UTC
...
public final class admin_005feditstudent_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<hr />\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"page_editteacourse\"><i\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t<div class=\"show_allstudent\">\n");
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default bootstrap-admin-no-table-panel\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-muted bootstrap-admin-box-title\">显示所有学生信息</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row search_admin twoblock\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-8\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>您可以输入学生的相关信息进行查询 ：</span>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<!-- /.col-lg-6 -->\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"show_onestudent\">\n");
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default bootstrap-admin-no-table-panel\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-muted bootstrap-admin-box-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"return_show_allstudent\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"page_editstudent\">返回</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t\t\t/ <a>编辑信息页面 </a>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"addstudent_context\">\n");
      out.write("\t\t\t\t\t\t\t\t<form class=\"form_editstudent\">\n");
      out.write("\t\t\t\t\t\t\t\t<h2>请修改该学生信息</h2>\n");
      out.write("\t\t\t\t\t\t\t\t<input style=\"display:none;\"  class=\"oldstudentid\" name=\"oldstudentid\"/>\n");
      out.write("\t\t\t\t\t\t\t\t<hr />\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-10\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control newstudentid\"  name=\"newstudentid\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"请输入新学生的学号\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<hr />\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-10\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control newstudentname\" name=\"newstudentname\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"请输入新学生的姓名\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<hr />\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control newstudentage\" name=\"newstudentage\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"newstudentsex\" id=\"inlineRadio1\" value=\"1\">男</label> <label class=\"radio-inline\"> <input type=\"radio\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"newstudentsex\" id=\"inlineRadio2\" value=\"0\">女</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<hr />\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control collage_t1\" name=\"newstudentcollage\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option selected value=\"信息科学与工程学院\">信息科学与工程学院</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control major_t1\" name=\"newstudentprofession\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option selected value=\"计算机科学与技术\">计算机科学与技术</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" name=\"newstudentgrate\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option class=\"class_t1\" value=\"1301\">1301</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option class=\"class_t2\" value=\"1302\">1302</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option class=\"class_t3\" value=\"1303\">1303</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-10\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"newstudentpassword\" value=\"\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"如果输入新的密码，则覆盖原来的密码\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<hr />\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"button_submit_reset\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-success submit_editstudent\" type=\"button\">提交</button>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(56,35) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fiterator_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(182,9) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setValue("list");
    // /WEB-INF/jsp/admin_editstudent.jsp(182,9) name = status type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fiterator_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_s_005felse_005f0(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_age\">");
        if (_jspx_meth_s_005fproperty_005f4(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_collage\">");
        if (_jspx_meth_s_005fproperty_005f5(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_major\">");
        if (_jspx_meth_s_005fproperty_005f6(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_class\">");
        if (_jspx_meth_s_005fproperty_005f7(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_edit\"><button class=\"btn btn-primary\"\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"submit\">edit</button></td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"student_delete\"><button class=\"btn btn-danger button_deletestudent\"\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"submit\">delete</button></td>\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</tr>\n");
        out.write("\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_s_005fproperty_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(184,15) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(185,35) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(186,36) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(187,35) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f0.setTest("sex == 1");
  ...
  private boolean _jspx_meth_s_005fproperty_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(188,35) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f4.setValue("age");
  ...
  private boolean _jspx_meth_s_005fproperty_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(189,39) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f5.setValue("collage");
  ...
  private boolean _jspx_meth_s_005fproperty_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(190,37) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f6.setValue("profession");
  ...
  private boolean _jspx_meth_s_005fproperty_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin_editstudent.jsp(191,37) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f7.setValue("grate");
