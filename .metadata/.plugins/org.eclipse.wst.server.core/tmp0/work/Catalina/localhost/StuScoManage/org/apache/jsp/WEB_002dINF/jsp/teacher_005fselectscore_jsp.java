 ...
 * Generated at: 2016-01-10 15:14:56 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"input_scoreid\">1</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"input_studentnum\">130405211</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"input_studentname\">GC</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"input_score\">88</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"input_scorestate\" style=\"color: #FF6600\">未录入</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody> \t\n");
      out.write("\t\t\t\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
