		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					...
					<li><a href="page_studentselectscore"><i
							class="glyphicon glyphicon-chevron-right"></i> 查询成绩</a></li>
					<li class="active"><a href="page_studentselectcourse"><i
					...
					<div class="panel panel-default bootstrap-admin-no-table-panel">
						...
						<div class="selectcourse_context">
									...
									<tbody>
										<s:iterator value="list" status="st">
											<tr>
												...
												<td class="student_num" style="display:none" ><s:property value="#session.userid"/> </td>
												<td class="course_num"><s:property value="list[#st.index][0]" /></td>
												<td><s:property value="%{list[#st.index][1]}" /></td>
												<td><s:if test="list[#st.index][2] == 1">必修</s:if><s:else>选修</s:else></td>
												<td><s:property value="list[#st.index][3]" /></td>
												<td class="teacher_num" style="display:none"><s:property value="list[#st.index][4]" /></td>
												<td><input type="checkbox" class="checkbox_checkcourse" name="bike" /></td>
											</tr>
										</s:iterator>
								...
								<div class="submit_selectcourse">
									<button class="btn btn-success submit_studentselectcourse" type="button">提交</button>
								</div>
						</div>
					</div>
				</div>
