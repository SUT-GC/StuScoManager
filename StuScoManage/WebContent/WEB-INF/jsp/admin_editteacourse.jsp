...
<body class="bootstrap-admin-with-small-navbar">
				...
				<div class="row">
					<div class="panel panel-default bootstrap-admin-no-table-panel">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">编辑教课信息</div>
						</div>
						<div class="row search_admin twoblock">
							<div class="col-lg-8">
								<span>您可以输入相关信息进行查询 ：</span>
							</div>
							<!-- /.col-lg-6 -->
							<div class="col-lg-4">
						...
						<table class="table table-hover mytable">
							...
							<tbody>
								...
								<s:iterator value="list" status="st" id="name">
									<tr>
										<td class="teacour_id"><s:property value="#st.index"/> </td>
										<td class="teacourseid" style="display:none"><s:property value="%{list[#st.index][0]}"/> </td>
										<td class="teacour_num"><s:property value="%{list[#st.index][1]}"/> </td>
										<td class="teacour_teaname"><s:property value="%{list[#st.index][2]}"/></td>
										<td class="teacour_cournum"><s:property value="%{list[#st.index][3]}"/></td>
										<td class="teacour_courname"><s:property value="%{list[#st.index][4]}"/></td>
										<td class="teacour_delete"><button class="btn btn-danger  button_deleteteacourse"
	...
	<script type="text/javascript" src="/StuScoManage/js/jquery.min.js"></script>
